...
const MISSIONS: Mission[] = [
  ...
  { 
    id: 'iss', name: 'ISS', year: '1998', status: 'CURRENT', 
  ...
  { 
    id: 'artemis2', name: 'Artemis II', year: '2025', status: 'FUTURE', 
  ...
  return (
    <div className="flex flex-col h-full w-full overflow-hidden relative">
      ...
      <div className="relative w-full overflow-x-auto pb-12 custom-scrollbar hide-scrollbar shrink-0 snap-x snap-mandatory min-h-[220px]">
        <div className="absolute top-[82px] left-0 w-full h-[1px] bg-white/5 -translate-y-1/2 rounded-full pointer-events-none" />
        <div className="flex items-center gap-24 px-24 min-w-max h-full pt-4">
            ...
            >
                ...
                >
                    ...
                    <div className="flex flex-col md:flex-row w-full overflow-y-auto custom-scrollbar">
                        ...
                        {/* Left: Tactical Visuals & Title (Fixed on top for mobile, sidebar on md) */}
