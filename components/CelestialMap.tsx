...
const EVENTS: CelestialEvent[] = [
    ...
    },
    {
        ...
        type: 'Solar Eclipse',
        visibility: 'High',
        explanation: 'The Moon completely blocks the Sun, casting a shadow on Earth. The sky turns dark as if it were dawn or dusk.',
        peakTime: '18:15 UTC',
        significance: 'Allows the observation of the solar corona, usually hidden by the Sun’s glare.',
        timeWindow: '17:30 - 19:00 (90m)',
        conditionSummary: 'Special eclipse glasses required for safety.',
        coordinates: [40.0, -3.7],
        position: { top: '32%', left: '49%' },
        targetDate: '2026-08-12T18:15:00Z',
        locationName: 'Northern Hemisphere / Europe',
        coordinatesText: 'LAT 40.0° N | LON 3.7° W'
    },
    {
        id: '5',
        name: 'Lunar Eclipse',
        ...
        type: 'Lunar Event',
        visibility: 'Medium',
        explanation: 'The Earth passes between the Sun and Moon, casting its shadow on the lunar surface, often turning it a deep copper red.',
        peakTime: '20:45 UTC',
        significance: 'A visual demonstration of Earth’s shadow geometry in the solar system.',
        timeWindow: '19:00 - 23:00 (4h)',
        conditionSummary: 'Visible to the naked eye from anywhere on the night side of Earth.',
        coordinates: [0, 0],
        position: { top: '54%', left: '50%' },
        targetDate: '2026-03-03T20:45:00Z',
        locationName: 'Global Visibility',
        coordinatesText: 'LAT 0.0° | LON 0.0°'
    },
    {
        id: '6',
        ...
        type: 'Meteor Shower',
        visibility: 'High',
        explanation: 'Fast-moving meteors originating from debris left by Halley’s Comet as Earth crosses its orbital path.',
        peakTime: '02:00 UTC',
        significance: 'Provides data on periodic comet debris streams and atmospheric interaction.',
        timeWindow: '22:00 - 05:00 (7h)',
        conditionSummary: 'Best viewed from a dark location after midnight.',
        coordinates: [15, 30],
        position: { top: '46%', left: '58%' },
        targetDate: '2026-10-21T02:00:00Z',
        locationName: 'Worldwide Observation',
        coordinatesText: 'LAT 15.0° N | LON 30.0° E'
    },
    {
        id: '7',
        name: 'ISS Visible Flyover',
        date: '2026-02-18',
        type: 'ISS Pass',
        visibility: 'High',
        explanation: 'A bright, fast-moving point of light representing human presence in space, visible shortly after sunset.',
        peakTime: '18:42 LOCAL',
        significance: 'Encourages public engagement and awareness of human spaceflight missions.',
        timeWindow: '18:40 - 18:45 (5m)',
        conditionSummary: 'Highest point of pass; visible even in urban environments.',
        coordinates: [19.07, 72.87],
        position: { top: '44%', left: '70%' },
        targetDate: '2026-02-18T18:42:00Z',
        locationName: 'South Asia / Mumbai Region',
        coordinatesText: 'LAT 19.1° N | LON 72.9° E'
    },
    {
        id: '8',
        ...
        visibility: 'Medium',
        explanation: 'Saturn appears at its brightest and largest as Earth passes between it and the Sun, making the rings highly visible.',
        peakTime: 'All Night',
        significance: 'The optimal window for high-resolution telescope observation of Saturnian rings.',
        timeWindow: 'Sunset to Sunrise',
        conditionSummary: 'Requires a telescope for ring detail; bright star-like appearance to naked eye.',
        coordinates: [-10, 120],
        position: { top: '60%', left: '83%' },
        targetDate: '2026-09-08T00:00:00Z',
        locationName: 'Southern Hemisphere Sky',
        coordinatesText: 'LAT 10.0° S | LON 120.0° E'
    },
    {
        id: '9',
        name: 'SpaceX Launch Window',
        date: '2026-04-11',
        type: 'Rocket Launch',
        visibility: 'Low',
        explanation: 'Scheduled mission window for a Falcon heavy-lift launch vehicle carrying orbital payloads.',
        peakTime: '14:00 UTC',
        significance: 'Critical milestone in commercial spaceflight and payload delivery logistics.',
        timeWindow: '14:00 - 16:00 (Launch Window)',
        conditionSummary: 'Weather dependent; visibility limited to local launch site and live stream.',
        coordinates: [28.5, -80.6],
        position: { top: '39%', left: '28%' },
        targetDate: '2026-04-11T14:00:00Z',
        locationName: 'Cape Canaveral / KSC',
        coordinatesText: 'LAT 28.5° N | LON 80.6° W'
    }
];
