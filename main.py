...
async def get_techport_data():
    ...
    # Using 'propulsion' keyword manually or just fetching latest projects and filtering on client
    # TechPort API is complex; fetching a list of recent projects is safer for a demo.
    # We'll fetch updated projects.
    ...
    try:
        async with httpx.AsyncClient() as client:
            ...
            data = resp.json()
            # Simply return raw list; frontend will pick 2-3 relevant ones
